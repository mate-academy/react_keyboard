[DEMO LINK](https://artemvlasiuk.github.io/react_keyboard/)
# React Keyboard
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_keyboard/) and add it to the PR description.
