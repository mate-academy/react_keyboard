...
> Here is [the working version](https://xmate-academy.github.io/react_keyboard/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Ruslan-oss-max0.github.io/react_keyboard/) and add it to the PR description.
