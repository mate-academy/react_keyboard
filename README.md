...
- use `componentDidMount` to add `keyup` handler:
    ...
    ```
- use `removeEventListenzer` to remove a global handler in `componentWillUnmount`.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://alaaashkar.github.io/react_keyboard/) and add it to the PR description.
